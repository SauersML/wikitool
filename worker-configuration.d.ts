/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ca09796908b195063045ea869dbbbd05)
// Runtime types generated with workerd@1.20260409.1 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WikiSearchMCP";
	}
	interface Env {
		ANTHROPIC_API_KEY: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").WikiSearchMCP>;
	}
}
